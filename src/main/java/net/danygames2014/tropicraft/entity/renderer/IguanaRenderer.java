...
public class IguanaRenderer extends EntityRenderer {
    public EntityModel iguanaModel;

    public IguanaRenderer() {
        this.field_2678 = 0.5F; // shadowRadius
        this.iguanaModel = new IguanaModel();
    }
    ...
    public void render(Entity entity, double x, double y, double z, float g, float h) {
        ...
        this.iguanaModel.render(0.0F,1.0F,0.1F,0.0F,0.0F,0.0625F);
        GL11.glPopMatrix();
    }
}
